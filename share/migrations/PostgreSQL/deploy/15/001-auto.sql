...
-- Created on Thu Jan  8 08:24:50 2026
--
;
--
-- Table: group
...
CREATE TABLE "host" (
  ...
  "group_id" integer,
  "silenced" smallint DEFAULT 0 NOT NULL,
  "collect_agents" smallint DEFAULT 1 NOT NULL,
  PRIMARY KEY ("id")
);
...
CREATE TABLE "user" (
  ...
  "web_enabled" boolean DEFAULT '0' NOT NULL,
  PRIMARY KEY ("id")
);
