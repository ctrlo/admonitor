...
-- Created on Thu Jan  8 08:37:45 2026
--
;
...
CREATE TABLE `host` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `host_fk_group_id` FOREIGN KEY (`group_id`) REFERENCES `group` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB;
--
-- Table: `user`
--
CREATE TABLE `user` (
  ...
  `web_enabled` boolean NOT NULL DEFAULT '0',
